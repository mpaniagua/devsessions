...
from .views import ChemicalViewSet,DeveloperViewSet, DeveloperTypeViewSet, CameraBodyViewset,FilmFormatViewSet,NegativeSizeViewSet,LensMountViewSet,LensTypeViewSet,LensViewSet
